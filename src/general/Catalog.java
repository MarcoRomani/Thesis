...
public class Catalog {
	...
	private Catalog() {
		...
		if(flag == false) {
			...
			double [][] t = {
					{245,(double)45.7,44,2200,128,128*2,10},
					{419,(double)67.2,56,2500,192,192*2,10},
					{469,55,56,2500,192,192*2,10},
					{459,(double)58.1,56,2500,192,192*2,10},
					{233,39,28,2500,48,48*2,10},
					{183,(double)45.6,28,2100,96,96*2,10},
					{426,(double)39.5,28,2500,192,192*2,10}
					};
