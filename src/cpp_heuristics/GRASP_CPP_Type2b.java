...
public class GRASP_CPP_Type2b extends GRASP_CPP_Type1Indexing {

	public GRASP_CPP_Type2b(DataCenter dc, List<CPPNeighborhood> neighs) {
		super(dc, neighs);
	}

	public GRASP_CPP_Type2b(DataCenter dc) {
		super(dc);
	}
